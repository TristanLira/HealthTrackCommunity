...
public class DoctorController {
    ...
    @FXML public Label selectedPatientNameLabel;
    ...
    private void showPatientMetrics(Patient patient) {
        ...
        selectedPatientNameLabel.setText(patient.getName());
    ...
    public void generateClinicalReport(ActionEvent event) {
        Patient selected = selectedPatientCache.get(selectedPatientNameLabel.getText());
        if (selected != null) {
